...
public class EnemyState : MonoBehaviour
{
    ...
    {
        isAlertedByAllEnemy = onEnemyAlert.IsAlertAllEnemy;
    ...
    void Start()
    {
        ...
        Debug.Log($"Starting enemy with {_enemyMovement.patrolPoints.Length} patrol points");
    }
    ...
    public void SetState(EnemyStateTypes newState)
    {
        ...
        switch (currentState)
        {
            ...
            case EnemyStateTypes.AlertingAllEnemy:
                _enemyMovement.StopMovement();
                EventDispatcher.Dispatch(new EventDefine.OnAlertAllEnemy { IsAlertAllEnemy = true });
